...
{
    [Table("HR_EmployeeComplianceMonthlyAttendenceSummery"), Index("EmployeeId", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_HR_EmployeeComplianceMonthlyAttendenceSummery_NonClusteredIndex")]
    public class EmployeeComplianceMonthlyAttendenceSummery : BaseModel1
    {
        [Key]
