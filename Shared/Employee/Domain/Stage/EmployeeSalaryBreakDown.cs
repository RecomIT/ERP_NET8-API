...
{
    [Table("HR_EmployeeCurrentSalaryBreakDown"), Index("EmployeeId", "AllowanceNameId", "IsActive", "Flag", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_HR_EmployeeCurrentSalaryBreakDown_NonClusteredIndex")]
    public class EmployeeSalaryBreakDown : BaseModel2
    {
        [Key]
