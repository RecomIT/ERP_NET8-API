...
{
    public class AllEmployeesTaxChallanInsertDTO
    {
        ...
        [Required(ErrorMessage = "Deposite bank branch is missing"), StringLength(100, ErrorMessage = "Deposite Bank branch character length upto 100 is not allowed")]
