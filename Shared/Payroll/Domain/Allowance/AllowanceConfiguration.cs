...
{
    [Table("Payroll_AllowanceConfiguration"), Index("AllowanceNameId", "StateStatus", "IsApproved", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_Payroll_AllowanceConfiguration_NonClusteredIndex")]
    public class AllowanceConfiguration : BaseModel4
    {
        [Key]
