...
{
    [Table("Payroll_EmployeeBonusTaxProcess"), Index("EmployeeId", "BonusMonth", "BonusYear", "FiscalYearId", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_Payroll_EmployeeBonusTaxProcess_NonClusteredIndex")]
    public class EmployeeBonusTaxProcess : BaseModel1
    {
        [Key]
