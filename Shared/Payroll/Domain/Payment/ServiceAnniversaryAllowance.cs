...
{
    [Table("Payroll_ServiceAnniversaryAllowance"), Index("AllowanceNameId", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_Payroll_ServiceAnniversaryAllowance_NonClusteredIndex")]
    public class ServiceAnniversaryAllowance : BaseModel2
    {
        [Key]
