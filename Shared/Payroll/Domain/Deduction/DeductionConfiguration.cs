...
{
    [Table("Payroll_DeductionConfiguration"), Index("DeductionNameId", "CompanyId", "OrganizationId", IsUnique = false, Name = "IX_Payroll_DeductionConfiguration_NonClusteredIndex")]
    public class DeductionConfiguration : BaseModel4
    {
        [Key]
