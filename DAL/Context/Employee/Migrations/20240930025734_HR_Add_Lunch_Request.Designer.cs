...
namespace DAL.Context.Employee.Migrations
{
    ...
    [Migration("20240930025734_HR_Add_Lunch_Request")]
    partial class HR_Add_Lunch_Request
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationColumnMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("IntegrationModuleId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SystemColumn")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("SystemTable")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.HasIndex("IntegrationModuleId");

                    b.ToTable("HR_IntegrationColumnMapping");
                });

            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("AuthenticationPrivateKey")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");

                    b.Property<string>("AuthenticationPrivateKeyFilePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AuthenticationPublicKey")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<string>("DataTransferType")
                        .HasMaxLength(20)
                    ...
                    b.Property<string>("DecryptionPrivateKey")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");

                    b.Property<string>("DecryptionPrivateKeyFilePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DecryptionPublicKey")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<string>("EncryptionPrivateKeyFilePath")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("HR_IntegrationConfig");
                });

            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationModule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HR_IntegrationModule");
                });
            ...
            modelBuilder.Entity("Shared.Employee.Domain.Miscellaneous.LunchRate", b =>
                {
                    b.Property<long>("LunchRateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("LunchRateId"));
                    ...
                    b.HasKey("LunchRateId");

                    b.HasIndex(new[] { "LunchRateId", "Rate", "ValidFrom", "ValidTo", "CompanyId", "OrganizationId", "BranchId" }, "IX_HR_LunchRate_NonClusteredIndex");

                    b.ToTable("HR_LunchRate");
                });

            modelBuilder.Entity("Shared.Employee.Domain.Miscellaneous.LunchRequest", b =>
                {
                    b.Property<long>("LunchRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("LunchRequestId"));
                    ...
                    b.HasKey("LunchRequestId");

                    b.HasIndex("LunchRateId");

                    b.HasIndex(new[] { "LunchRequestId", "EmployeeId", "LunchRateId", "RequestDate", "IsLunch", "IsCanceled", "RequestedOn", "RequestedByAdminId", "CompanyId", "OrganizationId", "BranchId" }, "IX_HR_LunchRequests_NonClusteredIndex");

                    b.ToTable("HR_LunchRequests");
                });
            ...
            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationColumnMapping", b =>
                {
                    b.HasOne("Shared.Employee.Domain.Integration.IntegrationModule", "IntegrationModule")
                        .WithMany("IntegrationColumnMappings")
                        .HasForeignKey("IntegrationModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IntegrationModule");
                });

            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationModule", b =>
                {
                    b.HasOne("Shared.Employee.Domain.Integration.IntegrationConfig", "IntegrationConfig")
                        .WithMany("IntegrationModules")
            ...
            modelBuilder.Entity("Shared.Employee.Domain.Miscellaneous.LunchRequest", b =>
                {
                    b.HasOne("Shared.Employee.Domain.Miscellaneous.LunchRate", "LunchRate")
                        .WithMany()
                        .HasForeignKey("LunchRateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LunchRate");
                });
            ...
            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationConfig", b =>
                {
                    b.Navigation("IntegrationModules");
                });

            modelBuilder.Entity("Shared.Employee.Domain.Integration.IntegrationModule", b =>
                {
                    b.Navigation("IntegrationColumnMappings");
                });
