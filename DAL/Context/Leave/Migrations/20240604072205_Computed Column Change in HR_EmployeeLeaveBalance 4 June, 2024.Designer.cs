...
namespace DAL.Context.Leave.Migrations
{
    ...
    [Migration("20240604072205_Computed Column Change in HR_EmployeeLeaveBalance 4 June, 2024")]
    partial class ComputedColumnChangeinHR_EmployeeLeaveBalance4June2024
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Leave.Domain.Balance.EmployeeLeaveBalance", b =>
                {
                    b.Property<long>("EmployeeLeaveBalanceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("EmployeeLeaveBalanceId"));
            ...
            modelBuilder.Entity("Shared.Leave.Domain.History.EmployeeLeaveHistory", b =>
                {
            ...
            modelBuilder.Entity("Shared.Leave.Domain.Request.EmployeeLeaveRequest", b =>
                {
                    b.Property<long>("EmployeeLeaveRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shared.Leave.Domain.Setup.LeaveSetting", b =>
                {
                    b.Property<long>("LeaveSettingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shared.Leave.Domain.Setup.LeaveType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shared.Leave.Domain.Setup.LeaveSetting", b =>
                {
                    b.HasOne("Shared.Leave.Domain.Setup.LeaveType", "LeaveType")
