...
namespace BLL.Expense_Reimbursement.Interface.ReqReimbursementuest
{
    public interface IReimbursementBusiness
    {
        Task<IEnumerable<RequestCountViewModel>> GetRequestCountReimbursementAsync(long authorityId, AppUser user);
        Task<DBResponse<RequestViewModel>> GetRequestDataReimbursementAsync(RequestFilter filter, AppUser user);
        ...
        Task<IEnumerable<RequestViewModel>> GetRequestDataListAsync(RequestFilter filter, AppUser user);
        Task<IEnumerable<EmailSendViewModel>> EmailSendAsync(EmailDataViewModel filter, AppUser user);
        Task<long> GetRequestCountEmployeeWiseAsync(long employeeId, string transactionType, AppUser user);
        Task<long> GetRequestIDAsync(RequestFilter filter, AppUser user);
