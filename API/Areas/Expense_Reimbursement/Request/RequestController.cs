...
namespace API.Expense_Reimbursement.Request
{
    ...
    public class RequestController : ApiBaseController
    {
        ...
        public RequestController(
           ...
           IRequestBusiness requestBusiness,
        ...
        public async Task<IActionResult> GetRequestCountEmployeeWiseAsync(long employeeId, string transactionType)
        {
            ...
            try
            {
                if (user.HasBoth)
                {
                    var data = await _requestBusiness.GetRequestCountEmployeeWiseAsync(employeeId, transactionType, user);
                    return Ok(data);
                }
        ...
        public async Task<IActionResult> GetRequestDataAsync([FromQuery] RequestFilter filter)
        {
            ...
            try
            {
                ...
                {
                    var data = await _requestBusiness.GetRequestDataAsync(filter, user);            
        ...
        public async Task<IActionResult> GetRequestDataListAsync([FromQuery] RequestFilter filter)
        {
            ...
            try
            {
                ...
                {
                    var data = await _requestBusiness.GetRequestDataListAsync(filter, user);
                    return Ok(data);                    
                }
        ...
        public async Task<IActionResult> GetAssetIdAsync(long requestId, long employeeId, string transactionType)
        {
            ...
            try
            {
                if (user.HasBoth && ModelState.IsValid)
                {
                    var data = await _requestBusiness.GetRequestDataAsync(new RequestFilter { RequestId = requestId, EmployeeId = employeeId, TransactionType = transactionType }, user);
        ...
        public async Task<IActionResult> EmailSendAsync([FromQuery] EmailDataViewModel request)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    var data = await _requestBusiness.EmailSendAsync(request, user);
                    return Ok(data);
                }
                return BadRequest(ResponseMessage.InvalidParameters);
            }
        ...
        public async Task<IActionResult> GetRequestIDAsync([FromQuery] RequestFilter filter)
        {
            ...
            try
            {
                if (user.HasBoth)
                {
                    var data = await _requestBusiness.GetRequestIDAsync(filter, user);
                    return Ok(data);
                }
                return BadRequest(ResponseMessage.InvalidParameters);
            }
